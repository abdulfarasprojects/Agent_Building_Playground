...
async def main():
    ...
    print("Reactive Memory Agent")
    print("This agent demonstrates REACTIVE memory loading - the agent decides when to search memory.")
    print("Features:")
    print("- Reactive memory loading (load_memory tool)")
